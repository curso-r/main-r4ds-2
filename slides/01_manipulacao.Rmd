...
knitr::include_graphics("img/01_manipulacao/amizade.jpg")
```
...
knitr::include_graphics("img/01_manipulacao/arte_dplyr.png")
```
...
alunos |>
  mutate(
    Nota1 = as.as.numeric(Nota1),
    Nota2 = as.as.numeric(Nota2),
...
estrelas |>
  pivot_longer(4:6, names_to = "variaveis", values_to = "cor") |>
  unite("cor_orgao", cor, variaveis, sep = "_")
```
