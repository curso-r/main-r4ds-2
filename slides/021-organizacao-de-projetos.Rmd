...
knitr::include_graphics("img/021-organizacao-de-projetos/condused.gif")
```
...
knitr::include_graphics("img/021-organizacao-de-projetos/rlogo.jpeg")
```
</center>
]
...
knitr::include_graphics("img/021-organizacao-de-projetos/rstudiologo.png")
```
</center>
]
...
`r colorido("Projetos do R e repositórios do GitHub são melhores amigos.")`
