...
Observamos que há lotes muito grandes. Podemos destaça-los utilizando a função `gghighlight()`. O principal argumento dela é uma condição para filtrar quais pontos serão destacados. No exemplo, destacamos casas com lotes maiores que 100000 pés quadrados.
